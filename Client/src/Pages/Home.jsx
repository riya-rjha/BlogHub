      ...
      {blogs.map((blog, index) => (
        ...
        >
          <div className="md:w-1/2 p-4 order-2 md:order-1">
            <h2 className="md:text-4xl text-2xl font-bold mb-4 text-center md:text-left">{blog.title}</h2>
            <p className={`text-gray-700 mb-4 md:text-justify text-center`}>{blog.desc.slice(0, 250)} <span className="font-bold">. . . .</span></p>
